...
//  int before_parse_flag = 0;
  ...
  float default_scale = 100, default_xRot = 0.0f, default_yRot = 0.0f, default_zRot = 0.0f, default_xMov = 0.0f,
  default_yMov = 0.0f, default_zMov = 0.0f;
  ...
  float scale = default_scale, xRot = default_xRot, yRot = default_yRot, zRot = default_zRot, xMov = default_xMov,
        yMov = default_yMov, zMov = default_zMov;
