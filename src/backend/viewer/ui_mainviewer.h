...
"padding: 5px;"));
        ...
        zoom_11 = new QFrame(frame);
        zoom_11->setObjectName(QString::fromUtf8("zoom_11"));
        zoom_11->setEnabled(true);
        QSizePolicy sizePolicy2(QSizePolicy::Minimum, QSizePolicy::Ignored);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(zoom_11->sizePolicy().hasHeightForWidth());
        zoom_11->setSizePolicy(sizePolicy2);
        zoom_11->setStyleSheet(QString::fromUtf8("QFrame {\n"
"color: white;\n"
"margin-top: 5px;\n"
...
"padding-right: 3px;\n"
"}"));
        zoom_11->setFrameShape(QFrame::StyledPanel);
        zoom_11->setFrameShadow(QFrame::Raised);
        gridLayout_23 = new QGridLayout(zoom_11);
        gridLayout_23->setObjectName(QString::fromUtf8("gridLayout_23"));
        perspective = new QRadioButton(zoom_11);
        perspective->setObjectName(QString::fromUtf8("perspective"));
        perspective->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));

        gridLayout_23->addWidget(perspective, 3, 0, 1, 1);

        parallel = new QRadioButton(zoom_11);
        parallel->setObjectName(QString::fromUtf8("parallel"));
        parallel->setEnabled(true);
        parallel->setTabletTracking(false);
        parallel->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        parallel->setChecked(true);

        gridLayout_23->addWidget(parallel, 1, 0, 1, 1);

        line_type_lablel_4 = new QLabel(zoom_11);
        line_type_lablel_4->setObjectName(QString::fromUtf8("line_type_lablel_4"));

        gridLayout_23->addWidget(line_type_lablel_4, 0, 0, 1, 1);


        gridLayout->addWidget(zoom_11, 5, 1, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(zoom_4->sizePolicy().hasHeightForWidth());
        zoom_4->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        sizePolicy4.setHeightForWidth(pointColor->sizePolicy().hasHeightForWidth());
        pointColor->setSizePolicy(sizePolicy4);
...
""));
        ...
        sizePolicy.setHeightForWidth(background_title->sizePolicy().hasHeightForWidth());
        background_title->setSizePolicy(sizePolicy);

        gridLayout_8->addWidget(background_title, 0, 0, 1, 2);


        gridLayout->addWidget(zoom_4, 5, 0, 1, 1);

        zoom_2 = new QFrame(frame);
        zoom_2->setObjectName(QString::fromUtf8("zoom_2"));
        zoom_2->setEnabled(true);
        sizePolicy3.setHeightForWidth(zoom_2->sizePolicy().hasHeightForWidth());
        zoom_2->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(point_size_title->sizePolicy().hasHeightForWidth());
        point_size_title->setSizePolicy(sizePolicy);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(translate_title->sizePolicy().hasHeightForWidth());
        translate_title->setSizePolicy(sizePolicy);
        ...
        sizePolicy3.setHeightForWidth(zoom->sizePolicy().hasHeightForWidth());
        zoom->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(rotate_title->sizePolicy().hasHeightForWidth());
        rotate_title->setSizePolicy(sizePolicy);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(rotate_title_3->sizePolicy().hasHeightForWidth());
        rotate_title_3->setSizePolicy(sizePolicy);
        ...
        sizePolicy6.setHeightForWidth(pathLine->sizePolicy().hasHeightForWidth());
        pathLine->setSizePolicy(sizePolicy6);
...
""));
        ...
        sizePolicy7.setHeightForWidth(fileBtm->sizePolicy().hasHeightForWidth());
        fileBtm->setSizePolicy(sizePolicy7);
...
""));
        ...
        sizePolicy3.setHeightForWidth(zoom_3->sizePolicy().hasHeightForWidth());
        zoom_3->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(line_width_title->sizePolicy().hasHeightForWidth());
        line_width_title->setSizePolicy(sizePolicy);
        ...
        sizePolicy2.setHeightForWidth(zoom_5->sizePolicy().hasHeightForWidth());
        zoom_5->setSizePolicy(sizePolicy2);
...
""));
    ...
    void retranslateUi(QMainWindow *MainViewer)
    {
        ...
        pointColor->setText(QCoreApplication::translate("MainViewer", "Points", nullptr));
        lineColor->setText(QCoreApplication::translate("MainViewer", "Lines", nullptr));
        BGColor->setText(QCoreApplication::translate("MainViewer", "Background", nullptr));
        resetColor->setText(QCoreApplication::translate("MainViewer", "Reset ", nullptr));
