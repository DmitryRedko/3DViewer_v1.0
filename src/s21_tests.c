...
START_TEST(test_1) {
    ...
    float moved_objData[24] = {1.25	,	1.00	,	-1.00	,	1.25	,	-1.00	,	-1.00	,	1.25	,	-1.00	,	1.00	,	1.25	,	1.00	,	
    -1.00	,	1.25	,	1.00	,	-1.00	,	-0.75	,	1.00	,	-1.00	,	-0.75	,	-1.00	,	1.00	,	-0.75	,	1.00	,	-1.00
};
...
START_TEST(test_2) {
    ...
    float moved_objData[24] = {1.00	,	1.87	,	-1.00	,	1.00	,	-0.13	,	-1.00	,	1.00	,	-0.13	,	1.00	,	1.00	,	1.87	,	-1.00	,	
    1.00	,	1.87	,	-1.00	,	-1.00	,	1.87	,	-1.00	,	-1.00	,	-0.13	,	1.00	,	-1.00	,	1.87	,	-1.00};
    move_operation(x_offset, y_offset, z_offset, &objData, &baseData);
...
START_TEST(test_3) {
    ...
    float moved_objData[24] = {1.00	,	1.00	,	-1.43	,	1.00	,	-1.00	,	-1.43	,	1.00	,	-1.00	,	0.57	,	1.00	,	1.00	,	-1.43	,	1.00	,	1.00	,	-1.43	,	-1.00	,	1.00	,	-1.43	,	-1.00	,	-1.00	,	0.57	,	-1.00	,	1.00	,	-1.43
};
    move_operation(x_offset, y_offset, z_offset, &objData, &baseData);
...
START_TEST(test_4) {
    ...
    float moved_objData[24] = {0.50	,	2.34	,	-1.11	,	0.50	,	0.34	,	-1.11	,	0.50	,	0.34	,	0.89	,	0.50	,	2.34	,	-1.11	,	0.50	,	2.34	,	-1.11	,	-1.50	,	2.34	,	-1.11	,	-1.50	,	0.34	,	0.89	,	-1.50	,	2.34	,	-1.11
};
    move_operation(x_offset, y_offset, z_offset, &objData, &baseData);
